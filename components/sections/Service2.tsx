				...
				<div className="container">
					<div className="rounded-3 border border-1 position-relative overflow-hidden">
						<div className="box-linear-animation position-relative z-1 p-lg-5 p-1 p-md-4">
							<div className="position-relative z-1">
								<div className="text-center">
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="text-linear-4 d-flex align-items-center"> Our Services </span>
									</div>
									<h3>
										Creating Solutions
										<span className="text-300">
											That Fit Your Unique Goals
										</span>
									</h3>
									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">WordPress Website Design &amp; Development</h6>
												<p className="fs-7 text-300 fw-regular">Create modern, responsive, and user-friendly WordPress websites — from corporate sites to personal blogs and online portfolios. <span className="text-secondary-2">HTML</span>, <span className="text-secondary-2">CSS</span>, <span className="text-secondary-2">JavaScript</span>, and Elementor.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Multi-language & Multi-vendor Site Setup</h6>
												<p className="fs-7 text-300 fw-regular">Create global-friendly websites with multi-language support or build a scalable multi-vendor marketplace using WordPress or custom MERN stack.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Build custom RESTful APIs or GraphQL endpoints and integrate third-party APIs (payment gateways, CRMs, etc.) into your web apps or WordPress websites. <span className="text-secondary-2">Property Data Api</span>, <span className="text-secondary-2">Others</span>, and <span className="text-secondary-2">CRM API</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Website Speed Optimization</h6>
												<p className="fs-7 text-300 fw-regular">Optimize your websites for lightning-fast performance using code splitting, lazy loading, caching, image compression, and CDN implementation.Work with <span className="text-secondary-2">Nodejs</span>, <span className="text-secondary-2">Express</span>, <span className="text-secondary-2">LiteSpeed Cache</span></p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Real-Time AI Chat & Notification Systems</h6>
												<p className="fs-7 text-300 fw-regular">Build real-time features like chat apps, live notifications, or activity feeds using Socket.io, Firebase, or other modern tech stacks.</p>
											</div>
										</div>
									</div>
							...
							<img className="position-absolute top-0 start-0 z-0" src="assets/imgs/home-page/services/bg.png" alt="Sahal" />
						</div>
					</div>
				</div>
			</section>
