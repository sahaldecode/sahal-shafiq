										...
										<div className="d-flex flex-column gap-2">
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													<img src="assets/imgs/home-page/experience/google.svg" alt="sahal" />
											...
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													<img src="assets/imgs/home-page/experience/twitter.svg" alt="sahal" />
													<div className="d-flex flex-column ms-2">
											...
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													<img src="assets/imgs/home-page/experience/amazon.svg" alt="sahal" />
													<div className="d-flex flex-column ms-2">
											...
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													<img src="assets/imgs/home-page/experience/payPal.svg" alt="sahal" />
													<div className="d-flex flex-column ms-2">
